...
//发射功率
	SI4432_WriteReg(0x6d, 0x00);//发射功率设置  0x00:+0dBM  0x01:+3dBM  0x02:+6dBM  0x03:+9dBM  0x04:+11dBM  0x05:+14dBM  0x06:+17dBM  0x07:20dBM
//手动打开接收
...
char User_SI4432_Thread(thread_t* pt)
{
	...
	//delay_ms(20);
		...
		SI4432_WriteReg(0x07, 0x09);//打开发射	   
		 while ( SI4432_NIRQ == 1){	Thread_Sleep(10);};      
