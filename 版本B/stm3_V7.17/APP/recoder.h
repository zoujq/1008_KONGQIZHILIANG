...
////////////////////////////////////////////////////////////////////////////////////////////
//各图标/图片路径
extern const u8* RECODER_DEMO_PIC;			//demo图片路径 	      
extern const u8* RECODER_RECR_PIC;			//录音 松开
extern const u8* RECODER_RECP_PIC;			//录音 按下
extern const u8* RECODER_PAUSER_PIC;		//暂停 松开
extern const u8* RECODER_PAUSEP_PIC;		//暂停 按下
extern const u8* RECODER_STOPR_PIC;			//停止 松开
extern const u8* RECODER_STOPP_PIC;			//停止 按下
////////////////////////////////////////////////////////////////////////////////////////////
 //RIFF块
