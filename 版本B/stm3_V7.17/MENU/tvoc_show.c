...
char TVOC_Show_Thread(thread_t* pt)//TVOC界面显示
{
...
////////////////////////////////////////////////////////////////////////// TVOC         ///////////////////////////////////////////////		
		if(CMachine_B.tvoc!=CMachine.tvoc)
		{
			...
			if(CMachine.tvoc<=224)//显示LOW
			{	
				if(CMachine_B.tvoc>224)
				{
					Show_NUM100_72(37,128,CMachine.tvoc/1000,0);			
					Show_NUM100_72(129,128,CMachine.tvoc%1000/100,0);					
					Show_NUM100_72(129+72,128,CMachine.tvoc%100/10,0);							
					Show_NUM100_72(129+144,128,CMachine.tvoc%10,0);	
					LCD_Fill(110,208,110+12,208+12,BLACK);	//TVOC的小数点					
				}				
				icon_show(124,146,132, 62, gImage_low_03,1);//		
				//icon_show_narrow(134, 78, 109, 31, gImage_tvocb_03,1,2);//显示	
				
			}else
			{
				if(CMachine_B.tvoc<=224)
				{
					icon_show(124,146,132, 62, gImage_low_03,0);//	
					 //icon_show_narrow(134, 78, 109, 31, gImage_tvocb_03,0,2);//显示	
