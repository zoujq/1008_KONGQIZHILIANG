...
struct typFNT_GB32_16// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[64];
};

struct typFNT_GB24_12// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[48];
};

struct typFNT_GB48_24// 汉字字模显示数据结构
{
	unsigned char Index[5];
...
struct typFNT_GB100_72// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[900];
};
struct typFNT_GB32_32// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[128];
};

struct typENG_GB16_32// 英文字字模显示数据结构
{
...
struct typFNT_GB21_16// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[42];
};

struct typFNT_GB44_32// 汉字字模显示数据结构
{
	unsigned char Index[5];
	unsigned char Msk[176];
};
struct typFNT_GB16_16// 汉字字模显示数据结构
{
	unsigned char Index[5];
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PAout(7) //LCD背光    		 PA7	    
//LCD地址结构体
typedef struct
{
	u16 LCD_REG;
...
#define BLUE 0x7E19//((119&0xf8)<<11)| ((188&0xfC)<<3)| ((40&0xf8)>>3)
#define GREEN 0x6D46
#define YELLOW 0xEF47
#define ORANGE 0xEC42
#define RED 0xE083
#define PINK 0xD8CE
...
void LCD_Picture_Full(const unsigned char* pstr);
